package java.com.github.Chestaci.pages.way2automation;
...
public class LoginPage extends Page {
     ...
     * @see com.github.Chestaci.pages.way2automation.HomePage
     */
    @Step("Заполнение полей ввода username: " +
            "{username}," + " password: {password}, usernameDescription: {usernameDescription} " +
            "и нажатие кнопки авторизации")
    public com.github.Chestaci.pages.way2automation.HomePage fillFieldsAndClick(String username, String password, String usernameDescription) {
